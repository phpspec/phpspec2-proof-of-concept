...
{
    public function described_with($runner)
    {
        $runner->is_an_instance_of('PHPSpec2\Runner');
    }

    public function should_be_aware_of_event_dispatcher($runner, $dispatcher)
    {
    ...
    public function should_accept_event_dispatcher_as_an_argument($runner, $dispatcher)
    {
        $dispatcher->is_a_mock_of('Symfony\Component\EventDispatcher\EventDispatcherInterface');
